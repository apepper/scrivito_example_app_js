...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "Kz": function() { return /* binding */ setNavigationStateProvider; },
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "P": function() { return /* binding */ observeDocumentTitle; },
/* harmony export */   "U": function() { return /* binding */ getDocumentTitle; }
/* harmony export */ });
/* harmony import */ var scrivito_sdk_state__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(7227);

var state = (0,scrivito_sdk_state__WEBPACK_IMPORTED_MODULE_0__/* .createStateContainer */ .JH)();
function observeDocumentTitle() {
    var observer = new MutationObserver(documentTitleChanged);
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "MY": function() { return /* binding */ initializeEditingContextFromBrowsingContext; },
...
/* harmony export */   "qN": function() { return /* binding */ forceNavigationStateNotResponsible; }
/* harmony export */ });
...
__webpack_require__.d(__webpack_exports__, {
  ...
  "c4": function() { return /* binding */ generateLocalPath; },
...
/* harmony export */   "p": function() { return /* binding */ setUiAdapter; }
/* harmony export */ });
var uiAdapter;
// For test purpose only.
// => allow undefined
...
__webpack_require__.d(__webpack_exports__, {
  ...
  "fv": function() { return /* reexport */ anticipatedMessageLink; },
  "bZ": function() { return /* reexport */ connectTo; },
  "hb": function() { return /* reexport */ createAdapterClient; },
  "Sp": function() { return /* reexport */ createAdapterConnection; },
  "B8": function() { return /* reexport */ createAdapterMessageClient; },
  "oc": function() { return /* reexport */ linkViaPort; },
  "kg": function() { return /* reexport */ postMessageLinkFor; },
...
function createAdapterClient(description, connection) {
    var adapterState = (0,state/* createStateContainer */.JH)();
    var adapterClient = {};
        ...
        if (methodType === adapter_description/* GET */.HT) {
            adapterClient[methodName] = function () {
                ...
                var state = adapterState
                    ...
                    .subState((0,common/* computeCacheKey */.mz)(params));
                var data = new loadable/* LoadableData */.of({
                    state: state,
...
function anticipatedMessageLink(linkPromise) {
    return {
        incomingMessages: (0,common/* anticipatedStream */.h0)(linkPromise.then(function (link) { return link.incomingMessages; })),
        sendMessage: function (message) {
...
function connectTo(uiWindow, eventLink, clientDescription) {
    var requestId = (0,common/* randomId */.kb)();
...
__webpack_require__.d(__webpack_exports__, {
  ...
  "o8": function() { return /* reexport */ replaceCmsRetrieval; },
  "AL": function() { return /* reexport */ retrieveObj; },
  "r4": function() { return /* reexport */ setupRegisterVerificator; },
  "kq": function() { return /* reexport */ useXmlHttpRequest; },
  "dx": function() { return /* reexport */ withEachAttributeJson; }
});

// UNUSED EXPORTS: AuthFailureCounter, ClientError, MissingWorkspaceError, UnauthorizedError, isComparisonRange, isObjSpaceId, requestBuiltInUserSession, retrieveObjFieldDiffs, useDefaultPriority
...
__webpack_require__.d(__webpack_exports__, {
  ...
  "fU": function() { return /* reexport */ Streamable; },
  "xQ": function() { return /* reexport */ Subject; },
  "h0": function() { return /* reexport */ anticipatedStream; },
  "$f": function() { return /* reexport */ appUrlFromPackagedUiUrl; },
  ...
  "k9": function() { return /* reexport */ windowLocationOrigin; }
});

// UNUSED EXPORTS: bypassThrottle, cleanUniqueErrorMessage, currentHash, detectUniqueErrorMessage, disableConsoleError, enableUniqueErrors, getChildPath, isUnderscore, replaceHistoryState, setNextTickScheduler, setScrivitoPromise, sliceFromIterable
...
function appUrlFromPackagedUiUrl(uiUrl) {
    var uri = new external_urijs_(uiUrl);
...
__webpack_require__.d(__webpack_exports__, {
  ...
  "kX": function() { return /* reexport */ ObjStreamReplication; },
  ...
  "$z": function() { return /* reexport */ setContentUpdateHandler; },
  "wi": function() { return /* reexport */ setObjStreamReplicationEndpoint; },
...
__webpack_require__.d(__webpack_exports__, {
  ...
  "Md": function() { return /* reexport */ setUrlResolutionHandler; },
  "Gf": function() { return /* reexport */ setupWriteMonitorNotification; },
...
/* harmony export */   "P6": function() { return /* binding */ setCurrentWorkspaceId; }
/* harmony export */ });
...
__webpack_require__.d(__webpack_exports__, {
  ...
  "EX": function() { return /* reexport */ setBinaryHandler; },
  "P6": function() { return /* reexport */ current_workspace_id/* setCurrentWorkspaceId */.P6; },
...
// UNUSED EXPORTS: BasicObjFacetValue, createObjWithSerializedAttributesIn, isCurrentWorkspacePublished, normalizedRestriction, resetCurrentWorkspaceId, restrictToGlobal, serializeAttributes
...
function init() {
    var lastState;
    (0,state/* observe */.N7)(function () { return (0,loadable/* capture */.IE)(current_page_data/* getCurrentPageData */["if"]).result; })
        .filter(common/* isPresent */.EN)
        .filter(function (pageData) {
        if (!pageData.currentPage)
            return false;
        var currentState = pageData.navigationState;
        var isDifferent = lastState === undefined ||
...
function switchToCanonicalUrl(pageData) {
    var location = pageData.navigationState.historyState.location;
    (0,loadable/* load */.zD)(function () {
        ...
        if (browser_location/* get */.U2() !== location)
            return;
        var locationUri = new external_urijs_(location);
...
var document_title = __webpack_require__(802);
// EXTERNAL MODULE: ./scrivito_sdk/app_support/editing_context.ts
var editing_context = __webpack_require__(6487);
...
var trusted_ui_origins_spreadArray = (undefined && undefined.__spreadArray) || function (to, from, pack) {
    if (pack || arguments.length === 2) for (var i = 0, l = from.length, ar; i < l; i++) {
        if (ar || !(i in from)) {
            if (!ar) ar = Array.prototype.slice.call(from, 0, i);
            ar[i] = from[i];
...
function checkIfTrustedOrigin(origin) {
    ...
    return getConfiguration().then(function (configuration) {
        var _a, _b;
        var adoptUi = configuration.adoptUi;
        if (typeof adoptUi === 'string' && originMatches(origin, adoptUi)) {
            return true;
        }
        var unstableOrigins = (_b = (_a = configuration.unstable) === null || _a === void 0 ? void 0 : _a.trustedUiOrigins) !== null && _b !== void 0 ? _b : [];
        var origins = trusted_ui_origins_spreadArray(trusted_ui_origins_spreadArray([], unstableOrigins, true), getLocalOrigins(), true);
        return origins.some(function (trustedOrigin) {
...
function getLocalOrigins() {
    ...
    try {
        ...
        // for this to work!
        return ((_b = (_a = localStorage.getItem('SCRIVITO_TRUSTED_UI_ORIGINS')) === null || _a === void 0 ? void 0 : _a.split(' ')) !== null && _b !== void 0 ? _b : []);
    }
    catch (anyError) {
        return [];
    }
...
function establishUiConnection(uiWindow) {
    var promiseForMessagePort = (0,bridge/* connectTo */.bZ)(uiWindow, (0,bridge/* postMessageLinkFor */.kg)(window), {
        clientVersion: (0,common/* getScrivitoVersion */.ux)(),
        clientCapabilities: ['adapterSpec'],
    }).then(function (_a) {
        var port = _a.port, origin = _a.origin;
        return checkIfTrustedOrigin(origin).then(function (trusted) {
            if (!trusted) {
                throw new common/* ScrivitoError */.Ix("Refusing to connect to Scrivito UI at unknown origin " + origin + ".");
            }
            return port;
        });
    });
    return (0,bridge/* createAdapterClient */.hb)(uiAdapterDescription, (0,bridge/* createAdapterMessageClient */.B8)((0,bridge/* anticipatedMessageLink */.fv)(promiseForMessagePort.then(bridge/* linkViaPort */.oc))));
}
...
function loadEditingSupport() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, assetLoadingReady()];
                case 1:
                    _a.sent();
                    return [2 /*return*/, __webpack_require__.e(/* import() */ 226).then(__webpack_require__.bind(__webpack_require__, 4556))];
            }
        });
    });
}
...
function appUrlForRedirectToCloudUi() {
    ...
    if (isParentHostDifferent())
        return null;
    var currentLocation = (0,common/* currentHref */.RO)();
    if (ui_adapter/* uiAdapter */.k)
        return currentLocation;
    return (0,common/* appUrlFromPackagedUiUrl */.$f)(currentLocation) || null;
}
function isParentHostDifferent() {
...
var ui_redirect_awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
        function rejected(value) { try { step(generator["throw"](value)); } catch (e) { reject(e); } }
...
var ui_redirect_generator = (undefined && undefined.__generator) || function (thisArg, body) {
    var _ = { label: 0, sent: function() { if (t[0] & 1) throw t[1]; return t[1]; }, trys: [], ops: [] }, f, y, t, g;
    return g = { next: verb(0), "throw": verb(1), "return": verb(2) }, typeof Symbol === "function" && (g[Symbol.iterator] = function() { return this; }), g;
    function verb(n) { return function (v) { return step([n, v]); }; }
    function step(op) {
...
function initializeUiRedirect() {
    return ui_redirect_awaiter(this, void 0, Promise, function () {
        var configuration;
        return ui_redirect_generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, getConfiguration()];
                case 1:
...
function handleAdoptUi(configuration) {
    var tenant = configuration.tenant, adoptUi = configuration.adoptUi;
    if (adoptUi) {
        var appUrlForUi = appUrlForRedirectToCloudUi();
        if (appUrlForUi) {
            var cloudUiUrl = adoptUi === true ? 'https://edit.scrivito.com' : adoptUi;
...
function initializeSdk() {
    ...
    (0,client/* useXmlHttpRequest */.kq)(XMLHttpRequest);
    initializeUiRedirect();
    var parentWindow = window.parent;
    var insideIFrame = parentWindow !== window;
    var windowName = window.name;
    var insideUi = insideIFrame && (0,editing_context/* initializeEditingContextFromBrowsingContext */.MY)(windowName);
    if (!insideUi) {
        (0,data/* useReplicationStrategy */.Lo)(data/* ObjBackendReplication */.kt);
    }
    else {
        var uiAdapterClient_1 = establishUiConnection(parentWindow);
        (0,ui_adapter/* setUiAdapter */.p)(uiAdapterClient_1);
        (0,client/* replaceCmsRetrieval */.o8)(uiAdapterClient_1);
        (0,models/* setBinaryHandler */.EX)(uiAdapterClient_1);
        (0,link_resolution/* setUrlResolutionHandler */.Md)(function (url) { return uiAdapterClient_1.getResolvedUrl(url) || null; });
        (0,link_resolution/* setupWriteMonitorNotification */.Gf)(function () { return undefined; });
        (0,data/* setContentUpdateHandler */.$z)(uiAdapterClient_1);
        (0,data/* setObjStreamReplicationEndpoint */.wi)(uiAdapterClient_1);
        (0,data/* useReplicationStrategy */.Lo)(data/* ObjStreamReplication */.kX);
        loadEditingSupport().then(function (editingSupport) {
...
var preload_awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
        function rejected(value) { try { step(generator["throw"](value)); } catch (e) { reject(e); } }
...
var preload_generator = (undefined && undefined.__generator) || function (thisArg, body) {
    var _ = { label: 0, sent: function() { if (t[0] & 1) throw t[1]; return t[1]; }, trys: [], ops: [] }, f, y, t, g;
    return g = { next: verb(0), "throw": verb(1), "return": verb(2) }, typeof Symbol === "function" && (g[Symbol.iterator] = function() { return this; }), g;
    function verb(n) { return function (v) { return step([n, v]); }; }
    function step(op) {
...
function preload(preloadDump) {
    ...
    return preload_awaiter(this, void 0, Promise, function () {
        var dumpLoaded;
        return preload_generator(this, function (_a) {
            switch (_a.label) {
                case 0:
